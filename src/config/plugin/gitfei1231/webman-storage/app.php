...
return [
    ...
    'storage' => [
        ...
        'local' => [
            ...
            'root' => public_path() . DIRECTORY_SEPARATOR .  'storage' . DIRECTORY_SEPARATOR,
            'dirname' => function () {
                return date('Ymd');
            },
            'domain' => 'http://127.0.0.1:8787',
            'uri' => DIRECTORY_SEPARATOR . 'storage' . DIRECTORY_SEPARATOR, // 如果 domain + uri 不在 public 目录下，请做好软链接，否则生成的url无法访问
            'algo' => 'sha1',
        ],
        // 阿里云对象存储
        'oss' => [
