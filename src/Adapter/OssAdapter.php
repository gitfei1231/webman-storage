        ...
        try {
            ...
            foreach ($this->files as $key => $file) {
                ...
                $temp = [
                    ...
                    'save_path' => str_replace('\\', DIRECTORY_SEPARATOR !== '/' ? '/' : DIRECTORY_SEPARATOR, $object),
                    'url' => str_replace('\\', DIRECTORY_SEPARATOR !== '/' ? '/' : DIRECTORY_SEPARATOR, $this->config['domain'].$this->dirSeparator.$object),
                    'unique_id' => $uniqueId,
                    'size' => $file->getSize(),
